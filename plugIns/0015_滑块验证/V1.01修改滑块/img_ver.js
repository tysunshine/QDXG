...
// 图形滑块验证码 DOM 生成
console.log(w);
    var html = '<div id="dragImgCanvasBox" style="display: none;position:absolute;bottom: 50px; left: 50%; margin-left: -' + (w / 2 + 16) + 'px;padding:16px 16px 28px;border:1px solid #ddd;background:#f2ece1;border-radius:16px;">';
